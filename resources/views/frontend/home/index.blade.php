		                                ...
		                                <ul class="product-list row">
		                                    ...
		                                    <li class="col-sm-6">
		                                        <div class="right-block">
		                                            <h5 class="product-name"><a href="#" title="{{$homeProduct->name}}">{{str_limit($homeProduct->name,20)}}</a></h5>
		                                        ...
		                                        <div class="left-block">
		                                            <a href="#"><img class="img-responsive" alt="product" src="{{ ($homeProduct->image )? route('image',$homeProduct->image_small) :  asset('assets/img/backend/no_image.jpg')}}" /></a>
